...
PROPOSICOES_AUTHORS_ENDPOINT     = 'proposicoes/{0}/autores'     # {0} = proposition id
...
CALLBACK_SHOW_AUTHORS      = "CALLBACK_SHOW_AUTHORS"
CALLBACK_AUTHORS_INFO      = "CALLBACK_AUTHORS_INFO"
CALLBACK_SHOW_KEY_WORDS    = "CALLBACK_SHOW_KEY_WORDS"
CALLBACK_SHOW_HISTORY      = "CALLBACK_SHOW_HISTORY"
CALLBACK_DESPACHO          = "CALLBACK_DESPACHO"